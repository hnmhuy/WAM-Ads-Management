...
export async function openSidePeek(data) {
    ...
    if (category === 'ad') {
      ...
      <div>
        ...
        let dataAdPlace = await fetch(`${serverHost}/api/ad_place/getOne?id=${adId}&includeAdContent=true`).then(res => res.json());
        // console.log("THISS IS DATA PLACE: ", dataAdPlace );
        // let dataAdPlace = await fetch(``${serverHost}/api/ad_place/getOne?id=e295a4ee-5591-4270-9c7f-922b33fb7d72&includeAdContent=true`).then(res => res.json());
